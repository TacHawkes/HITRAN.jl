...
instrument_lorentzian(x, res) = @. res / 2.0 / π / (x^2 + (res / 2.0)^2)
...
const instrument_functions = Dict{Symbol, Function}(:rectangular => instrument_rectangular,
...
"""
function apply_instrument_function(ν::AbstractVector{T},
                                   α::AbstractVector{T},
                                   instrument_function::Symbol = :rectangular,
                                   instrument_wing::AbstractFloat = 10.0,
                                   instrument_resolution::AbstractFloat = 0.1) where {
                                                                                      T <:
                                                                                      AbstractFloat
                                                                                      }
    δν = ν[2] - ν[1]
